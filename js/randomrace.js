...
var tirada1=0;
var tirada2=0;
var celdascircuito1 = []; //array para almacenar las celdas del circuito 1
var celdascircuito2 = []; //array para almacenar las celdas del circuito 2
var tam1 = 0, tam2 = 0; //variables con el tamaño de cada circuito
var colorTecla = "whitesmoke";
var colorMargen = "black";
var colorCoche1 = "#5B7721";
var colorCoche2 = "#91CD72";
/*
   función que define el tablero y recoge el circuito 1
*/
function pintaCircuito1() {
  ...
  for (let i = 0; i < numRows; i++) {
    ...
    for (let j = 0; j < numCols; j++) {
      const cell = $("<td></td>");
      cell.click(function () {
        // Añade un click event listener a cada celda
  ...
  console.log("Se ha pintado el tablero!!!")
  console.log("Hay que dibujar el circuito!!!")
  // Example: Access the celdascircuito1 array outside of the click event
  $("#getcoordenadas1").click(function () {
...
function salidaCoches() {
  ...
  //$(referencia1).css("background-image","url('images/car1.png')");
  //.css("background-image","url('images/car1.png')");
  ...
  //.css("background-image","url('images/car2.png')");
...
function rollCoche2() {
  ...
  console.log("La ubicación del ordenador es: ", celdascircuito2[pos1]);
  posant2 = pos2;
...
function mueveCoche1() { //función que borra y pinta el coche 1 emulando su movimiento
  ...
  let referenciaant = "table tr:eq(" + x + ") td:eq(" + y + ")";
  $(referenciaant).css("background-color", colorCoche1);
  x = celdascircuito1[pos1]['row'];
  y = celdascircuito1[pos1]['col'];
  let referencia = "table tr:eq(" + x + ") td:eq(" + y + ")";
  $(referencia).css("border-radius", "50%");
}
function mueveCoche2() { //función que borra y pinta el coche 2 emulando su movimiento
  ...
  let referenciaant = "table tr:eq(" + x + ") td:eq(" + y + ")";
  $(referenciaant).css("background-color", colorCoche2);
